...
/*   Updated: 2021/05/08 05:08:05 by ccastill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	cub->texture.p_sp = mlx_xpm_file_to_image(cub->mlx.ptr, g_check.texture_s,
...
{
	cub->texture.p_so = mlx_xpm_file_to_image(cub->mlx.ptr, g_check.texture_so,
