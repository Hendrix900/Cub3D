...
/*   Updated: 2021/03/08 21:13:31 by ccastill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub3d.h"

void     set_texture2(t_cub *cub, t_raycast * ray)
{
...
void     set_texture(t_raycast *ray, t_player *player, t_cub *cub)
{
	...
	cub->texture.pos = (ray->draw_start - g_check.res_h / 2 + ray->line_height / 2) * cub->texture.step;
}